...
class NPC(AnimatedSprite):
    ...
    def update(self):
        ...
        self.get_sprite()
        self.run_logic()
        # self.draw_ray_cast() # 2d mode orange line npc line of sight of player
    ...
    def movement(self):
        ...
        # shows the next tile the npc will take with a blue square 
    ...
    # line of sight enemy shoot through walls
    @property 
    def map_pos(self):
